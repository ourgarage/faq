...
return [
    ...
    'qa' => [
        ...
        'popup' => [
            'activate' => 'Вы действительно хотите включить этот вопрос-ответ?',
            'deactivate' => 'Вы действительно хотите выключить этот вопрос-ответ?',
            'delete' => 'Вы действительно хотите удалить этот вопрос-ответ?',
        ],
